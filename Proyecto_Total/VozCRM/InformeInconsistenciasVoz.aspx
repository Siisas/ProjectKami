<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InformeInconsistenciasVoz.aspx.vb" Inherits="digitacion.InformeInconsistenciasVoz" %>
            ...
            <tr>
                ...
                <td class="style11">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Informe De Inconsistencias Voz</asp:Label>
                </td>
                <td class="style10">
                    </td>
            </tr>
