<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="liberarasigseguimdigit.aspx.vb" Inherits="digitacion.liberarasigseguimdigit" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Liberar Asignación Digitación Seguimientos Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
