<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SeguimientoIlocalizableV.aspx.vb" Inherits="digitacion.SeguimientoIlocalizableV" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Seguimiento Ilocalizable Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
