<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="liberarasiggestionvoz.aspx.vb" Inherits="digitacion.liberarasiggestionvoz" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Liberar Asignación Gestión Claro Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    valign="top" class="style3">
                                <asp:Panel ID="Panel2" runat="server">
                                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                                        ...
                                        <tr>
                                            <td class="textotittabla">
                                                Liberacion Masiva</td>
                                            <td class="celdascons">
                                                <asp:CheckBox ID="CheckBoxLiberacion" runat="server" 
                                                    Text="¡¡Cuidado al seleccionar esta opcion realizara una liberacion masiva!!" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
