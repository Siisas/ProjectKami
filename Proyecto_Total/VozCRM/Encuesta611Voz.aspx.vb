...
Public Class Encuesta611Voz
    ...
    Public Sub Exportarxls()
        Try
            ...
            Response.AddHeader("Content-Disposition", "attachment;filename=611_voz:" + Lblfeci.Text + "-" + Lblfecf.Text + ".xls")
