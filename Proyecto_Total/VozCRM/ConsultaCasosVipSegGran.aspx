<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ConsultaCasosVipSegGran.aspx.vb" Inherits="digitacion.ConsultaCasosVipSegGran" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Consulta Casos VIP o de Segmento Grande</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                        <tr>
                            <td class="textotittabla">
                                Fecha de Inicio</td>
                            <td class="celdascons">
                                <asp:TextBox ID="TxtFecha_Inicio" runat="server" MaxLength="10" 
                                    placeholder="DD/MM/YYYY" Width="24%"></asp:TextBox>
                                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                    ControlToValidate="TxtFecha_Inicio" ErrorMessage="Revise hora" 
                                    Operator="DataTypeCheck" Type="Date">*</asp:CompareValidator>
                            </td>
                            <td class="textotittabla">
                                Fecha Fin</td>
                            <td class="celdascons">
                                <asp:TextBox ID="TxtFecha_Fin" runat="server" MaxLength="10" 
                                    placeholder="DD/MM/YYYY" Width="24%"></asp:TextBox>
                                <asp:CompareValidator ID="CompareValidator3" runat="server" 
                                    ControlToValidate="TxtFecha_Fin" ErrorMessage="Revise hora" 
                                    Operator="DataTypeCheck" Type="Date">*</asp:CompareValidator>
                            </td>
                        </tr>
                        </table>
