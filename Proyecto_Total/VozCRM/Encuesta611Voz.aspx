<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Encuesta611Voz.aspx.vb" Inherits="digitacion.Encuesta611Voz" %>
            ...
            <tr>
                ...
                <td style="font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    ...
                    <asp:Panel ID="PnlEncuesta" runat="server" Height="191px" Visible="False">
                        <table class="auto-style26" style="border: thin groove #000000;" border="1" >
                            <tr>
                                <td style="background-color: #409131; color: #FFFFFF; font-family: verdana, Geneva, Tahoma, sans-serif; text-align: center;" class="auto-style28" colspan="3">
                            ...
                            <tr>
                                ...
                                <td class="auto-style27" style="background-color: #409131; color: #FFFFFF; font-family: verdana, Geneva, Tahoma, sans-serif">
