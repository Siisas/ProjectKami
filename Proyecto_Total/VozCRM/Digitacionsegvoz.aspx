<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Digitacionsegvoz.aspx.vb" Inherits="digitacion.Digitacionsegvoz" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Digitación Seguimientos Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="celdascons">
                                                <asp:RadioButtonList ID="rbtipo" runat="server" Width="241px">
                                                    <asp:ListItem Value="1">Digitado</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                    </table>
