<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LiberarDigitacion.aspx.vb" Inherits="digitacion.LiberarDigitacion" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Liberar Asignación Digitación Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
