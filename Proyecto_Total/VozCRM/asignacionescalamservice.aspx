<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="asignacionescalamservice.aspx.vb" Inherits="digitacion.asignacionescalamservice" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Asignación Escalamiento Service Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="celdascons">
                                                ...
                                                <asp:CompareValidator ID="CompareValidator2" runat="server" 
                                                    ControlToValidate="txtcaso" ErrorMessage="La información no es válida" 
                                        ...
                                        <tr>
                                            ...
                                            <td class="celdascons">
                                                ...
                                                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                                    ControlToValidate="txtcantidad" ErrorMessage="La información no es válida" 
                                                    Operator="DataTypeCheck" Type="Integer">*</asp:CompareValidator>
                                            </td>
                                        </tr>
                                    </table>
