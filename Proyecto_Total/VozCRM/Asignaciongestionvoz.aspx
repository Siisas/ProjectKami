<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Asignaciongestionvoz.aspx.vb" Inherits="digitacion.Asignaciongestionvoz" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Asignación Gestión Casos Claro Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
    ...
    class="style1">
                                        ...
                                        <tr>
                                            <td class="textotittabla">
                                                Jefe Inmediato</td>
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drlJefe" runat="server" Width="322px" AutoPostBack="True"></asp:DropDownList> </td>
                                        </tr>
                                        <tr>
                                            <td class="textotittabla">
                    ...
                    valign="top" class="style3">
                                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                                            ...
                                            <td class="textotittabla" colspan="2">
                                                <center>Filtros para realizar busqueda</center></td>
                                        </tr>
                                            <td class="textotittabla">
                                                Casos Pendientes por Asignar</td>
                                            <td class="celdascons">
                                        ...
                                        <tr>
                                            <td class="textotittabla">
                                                Numero de intentos</td>
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drlNumIntentos" runat="server" 
                                                    Height="22px" Width="122px" Enabled="False">
            ...
            <tr>
                ...
                <td style="width:15%; font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    ...
                    <asp:GridView ID="dtgestad" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="idusuarioasig" HeaderText="Agente" />
                    ...
                    <asp:GridView ID="dtgAgentes" runat="server" AllowPaging="True" 
                        AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                        GridLines="None" PageSize="20" Width="48%" style="font-size: x-small" 
