<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="nuevoformato.aspx.vb" Inherits="digitacion.nuevoformato" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Creación Nuevos Formatos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
    ...
    class="style1">
                                ...
                                <asp:Label ID="lblmesa" runat="server"></asp:Label>
                                            ...
                                            <td class="textotittabla">
                                                Usuario Solicita</td>
                                            <td>
                                <asp:Label ID="lblusuariosolic" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="textotittabla">
                ...
                <td class="celdascent">
                    ...
                    <asp:GridView ID="dtggeneral" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="mesa" HeaderText="Mesa a Escalar" />
                            <asp:BoundField DataField="min_ac" HeaderText="MIN" />
                            <asp:BoundField DataField="fcreg" HeaderText="Fecha de Registro" />
                            <asp:BoundField DataField="idusuario" HeaderText="Agente Solicita" />
                        </Columns>
