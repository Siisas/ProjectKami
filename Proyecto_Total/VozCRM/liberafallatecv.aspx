<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="liberafallatecv.aspx.vb" Inherits="digitacion.liberafallatecv" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Liberar Asignación Fallatec Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
