<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Asignacionsegdigitac.aspx.vb" Inherits="digitacion.Asignacionsegdigitac" %>
...
<body>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Asignación Digitación Seguimientos Datos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
    ...
    class="style1">
                                        ...
                                        <tr>
                                            <td class="textotittabla">
                                                Asignar Registro Individual</td>
                                            <td class="celdascons">
                                        ...
                                        <tr>
                                            <td class="textotittabla">
                                                Total registros pendientes por Asignar</td>
                                            <td class="celdascons">
                                        ...
                                        <tr>
                                            <td class="textotittabla">
                                                Cantidad de Registros a Asignar</td>
                                            <td class="celdascons">
            ...
            <tr>
                ...
                <td style="width:15%; font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    ...
                    <asp:GridView ID="dtgestad" runat="server" AllowPaging="True" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="idusuariodigita" HeaderText="Digitador" />
            ...
            <tr>
                ...
                <td class="celdascent">
                    ...
                    <asp:GridView ID="dtggeneral" runat="server" AllowPaging="True" 
                        ...
                        <RowStyle BackColor="#EEF1D8" ForeColor="#333333" />
                        <Columns>
                            <asp:BoundField DataField="idcall" HeaderText="Id" />
                            <asp:BoundField DataField="contrato" HeaderText="Caso" />
                            <asp:BoundField DataField="fcregistro" HeaderText="Fecha Llamada" />
                            <asp:BoundField DataField="estado" HeaderText="Estado Llamada" />
                        </Columns>
                        <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
                        <PagerStyle BackColor="#284775" ForeColor="White" HorizontalAlign="Center" />
                        <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
            ...
            <tr>
                ...
                <td class="celdascent">
                    ...
                    <asp:GridView ID="dtgxls" runat="server" AllowPaging="True" 
                        AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" 
                        GridLines="None" PageSize="10000" Width="100%" style="font-size: x-small" 
                        EnableModelValidation="True">
                        <RowStyle BackColor="#EEF1D8" ForeColor="#333333" />
                        <Columns>
                            <asp:BoundField DataField="idcall" HeaderText="Id" />
