<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="liberaasignaciondigitac.aspx.vb" Inherits="digitacion.liberaasignaciondigitac" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Liberar Asignación Digitación Ilocalizados Datos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
