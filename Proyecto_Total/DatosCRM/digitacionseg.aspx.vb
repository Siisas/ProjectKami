Public Class digitacionseg
    ...
    Protected Sub casosptes()
        Try
            ...
            dtggeneral.DataSource = objdatos.consultaasignadodigitacdatosseguim
            dtggeneral.DataBind()
    ...
    Protected Sub btnguardar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnguardar.Click
        ...
        Try
            ...
            End If
            objdatos.actualizadigitdtseguim()
            casosptes()
    ...
    Protected Sub btnconsultar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnconsultar.Click
        Try
            ...
            objdatos.caso = txtcaso.Text
            objdatos.idusuario = lblusuario.Text
            objdatos.consultadigitarseguim()
