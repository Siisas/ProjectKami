<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="regcrm2.aspx.vb" Inherits="digitacion.regcrm2" %>
                ...
                <article>
                    <section>
                        ...
                        <div class="Form">
                            <div class="Cell-Form">
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        Caso   
                                            <asp:CompareValidator ID="CompareValidator2" runat="server" ControlToValidate="txtcaso" ErrorMessage="El caso debe ser un valor numérico" ValidationGroup="VG_Consultar" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
                                    </div>
                                    <asp:TextBox ID="txtcaso" runat="server" CssClass="form-control"></asp:TextBox>
                                    <span class="input-group-btn">
                                        <asp:Button ID="Btn_Consultar" runat="server" ValidationGroup="VG_Consultar" Text="Buscar" CssClass="btn btn-crm" />
                                    </span>
                                </div>
                            </div>
                            <%--CELDA DEL CENTRO--%>
                            ...
                            <div class="Cell-Form">
                                <%--<asp:Button ID="btncrea" runat="server" CssClass="btn btn-crm" Text="Crear Caso" Visible="false" />
                        ...
                        <asp:Panel ID="Panel_consulta" runat="server" Visible="true">
                            <div class="Form">
                                ...
                                <div class="Cell-Form">
                                    ...
                                    <%--bandeja--%>
                                    <asp:Label ID="lblBandeja" runat="server" Visible="false" Style="background-color: inherit" CssClass="form-control" Enable="False"></asp:Label>
                                </div>
                            </div>
                        </asp:Panel>
                        <%--------------------FALLA MASIVA--------------%>
                        ...
                        <asp:Panel ID="Panel_registro" runat="server" Visible="true">
                            ...
                            <div class="Form">
                                <div class="Cell-Form">
                                    <div class="input-group">
                                        <asp:Button ID="btnguardar" runat="server" Text="Guardar"  ValidationGroup="VG_Registrar" CssClass=" btn btn-crm" />
                                    </div>
                                </div>
                                <%--CELDA DEL CENTRO--%>
                                <div class="Space-Form"></div>
                    ...
                    <section>
                        ...
                        <asp:Panel ID="Pninc" runat="server" Visible="False">
                            ...
                            <div class="Form">
                                <div class="Cell-Form">
                                    <%--custcode--%>
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Type="Decimal" Display="Dynamic" runat="server" ControlToValidate="Txt_custcode" ValidationGroup="VG_Reg_Inconsistencia" ValidationExpression="([0-9]|\.)*">El custcode debe ser numerico</asp:RegularExpressionValidator>
                                    <div class="input-group">
...
<%--                        <%--NUEVO CASO INBOUND
                        <asp:Panel ID="pnnuevo" runat="server" Visible="false">
                            <div class="text-center TituloCRM">NUEVO REGISTRO INBOUND</div>
                            <div class="Form">
                                <div class="Cell-Form">
                                    <div class="input-group">
                                        <div class="input-group-addon">Tipo</div>
                                        <asp:RadioButtonList ID="rdbtipoinb" runat="server" CssClass="form-control" Font-Size="XX-Small">
                                ...
                                <div class="Cell-Form">
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            Min
                                                <asp:CompareValidator ID="CompareValidator7" runat="server" ControlToValidate="txtminnv" ErrorMessage="El min es numérico sin espacios ni caracteres" Operator="DataTypeCheck" Type="Double">*</asp:CompareValidator>
                                        </div>
                                        <asp:TextBox ID="txtminnv" runat="server" MaxLength="10" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-addon">Nombre</div>
                                        <asp:TextBox ID="txtnombrenv" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-addon">Ingeniero Remite</div>
                                        <asp:TextBox ID="TxtIngRemite" runat="server" CssClass="form-control"></asp:TextBox>
                                    </div>
                                    <div class="input-group">
                                        <asp:Button ID="btnguardar2" runat="server" Text="Guardar" CssClass="btn btn-crm" />
                                    </div>
                                </div>
                            </div>
                        </asp:Panel>--%>
