<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Control_Escalamiento_CPD.aspx.vb" Inherits="digitacion.Control_Escalamiento_CPD" %>
                        ...
                        <div class="Form">
                            <div class="Cell-Form">
                                ...
                                <div class="input-group"> 
                                    ...
                                    <asp:DropDownList ID="Drl_Estado_Remedy" runat="server" CssClass="form-control"></asp:DropDownList>
                                </div>
                                <div class="input-group"> 
