<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Liberarasigseguim.aspx.vb" Inherits="digitacion.Liberarasigseguim" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Liberar Asignación Digitación Seguimientos Datos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
