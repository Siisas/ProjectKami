<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="digitaciondt.aspx.vb" Inherits="digitacion.digitaciondt" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Digitación Ilocalizados Datos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:15%; font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    valign="top" class="style3">
                                <asp:Label ID="lblguion" runat="server" Font-Size="X-Small"></asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
    ...
    class="style1">
                                        <tr>
                                            <td class="textotittabla">
                                                Tipo de Cierre</td>
                                            <td class="celdascons">
                                                <asp:RadioButtonList ID="rbtipo" runat="server" Width="241px">
                                                    <asp:ListItem Value="1">Cerrado Digitador</asp:ListItem>
                                                    <asp:ListItem Value="2">Previamente Cerrado</asp:ListItem>
                                                    <asp:ListItem Value="3">Abierto Escalado</asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                    </table>
