<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CasosProgramados.aspx.vb" Inherits="digitacion.CasosProgramados" %>
        ...
        <tr>
                ...
                <td class="auto-style1">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Casos Programados</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
         ...
         <tr>
                ...
                <td style="font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    valign="top" class="auto-style3">
                    <asp:Button ID="btnNivel1" runat="server" Text="Nivel 1" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="btnNivel2" runat="server" Text="Nivel 2" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         ...
         <tr>
                ...
                <td style="font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    ...
                    <asp:Label ID="lblHoraactual" runat="server" Visible="False"></asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                            ...
                            <td class="celdascons" colspan="2">
                                <asp:GridView ID="dtgConsultaAmdocs" runat="server" AllowPaging="True" AutoGenerateColumns="false" CellPadding="4" EnableModelValidation="false" ForeColor="#333333" GridLines="None" PageSize="90" style="font-size: x-small" Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="fcprogram" HeaderText="Fecha de programacion" />
                                    </Columns>
