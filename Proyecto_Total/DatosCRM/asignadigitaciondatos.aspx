<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="asignadigitaciondatos.aspx.vb" Inherits="digitacion.asignadigitaciondatos" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Asignación Digitación Ilocalizados Datos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    <table class="style2">
                        ...
                        <tr>
                            ...
                            <td style="width: 70%" rowspan="1">
                                            <asp:Button ID="btnxls" runat="server" Text="Exportar Excel" Width="102px" />
                            </td>
                        </tr>
                    </table>
                </td>
