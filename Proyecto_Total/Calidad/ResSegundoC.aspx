<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResSegundoC.aspx.vb" Inherits="digitacion.ResSegundoC" %>
        ...
        <table style="width:100%; height: 100%">
            ...
            <tr>
                <td class="celdasder">
                    &nbsp;</td>
                <td class="style4">
                    <asp:Label ID="Label1" runat="server" ForeColor="#8F9E45"><h4><em>Respuesta De Segundo Concepto</em></h4></asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                                     ...
                                     <asp:GridView ID="DtgAuditoria" runat="server" AllowPaging="True" CellPadding="4" ForeColor="#333333"
                                            ...
                                            <RowStyle BackColor="#EEF1D8" ForeColor="#333333" Font-Underline="False" />
                                              <Columns>
                                                ...
                                                <asp:ButtonField CommandName="Solicitar" HeaderText="Revisar" Text="Respuesta" />
                                            </Columns>
                       ...
                       <tr>
                            ...
                            <td colspan="3">
                                <div class="text-center" style="color: #B3C556; font-size:large; border-radius: 5px; padding: 0.5px 0px 1px 0px">
                                    <strong>Observacion Auditor:</strong>
                                </div>
                            </td>
                         ...
                         <tr>
                            ...
                            <td style="width: 25%">
                                      <asp:Button ID="BtnRatifica" runat="server" Text="Ratifica" CssClass="btn btn-primary" />
                                  <asp:Button ID="BtnNoRatifica" runat="server" Text="NO ratifica" CssClass="btn btn-primary" />
                                  <asp:Button ID="BtnVolver1" runat="server" Text="Volver" CssClass="btn btn-primary" />      
                           </td>
                            <td style="width:5%"></td>
                            <td style="width: 25%"><div class="form-group" >
