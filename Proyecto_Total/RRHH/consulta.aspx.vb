...
Public Class consulta
    ...
    Sub buscarinf()
        ...
        'dtgUsuarios.DataSource = objdatos.Consulta_Personal_UsuPass
        'dtgUsuarios.DataBind()
        'LblCantUsuarios.Text = objdatos.cantidad
        If TxtFechaInicio.Text <> "" Or TxtFechaFin.Text <> "" Then
            objdatos.deporte = CType(Session("permisos"), clsusuario).perfil
            dtgHistoricoDisciplinario.DataSource = objdatos.Consulta_Historico_Disciplinario
            dtgHistoricoDisciplinario.DataBind()
            LblCantHistDis.Text = objdatos.cantidad
        End If
    ...
    Sub crearexcel()
        ...
        If lblcantgral.Text <> 0 Then
            If lblcantgral.Text < 20001 Then
                ...
                End If
                dtggeneral.DataSource = r.consultapersonal
                dtggeneral.DataBind()
                dtggeneral.Visible = True
                dtggeneral.EnableViewState = False
    ...
    Protected Sub lnkgneral_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkgneral.Click
        ...
        dtgHistoricoDisciplinario.Visible = False
    ...
    Protected Sub lnkcheck0_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkcheck0.Click
        ...
        dtgUsuarios.Visible = False
    End Sub
    Protected Sub LnkHistoricoDisciplinacrio_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LnkHistoricoDisciplinacrio.Click
        dtggeneral.Visible = False
        dtghistorico.Visible = False
        dtgcheck.Visible = False
        dtgnovedad.Visible = False
        dtgHistoricoDisciplinario.Visible = True
        dtgUsuarios.Visible = False
    End Sub
    Protected Sub LnkUsuPas_Click(ByVal sender As Object, ByVal e As EventArgs) Handles LnkUsuPas.Click
        dtggeneral.Visible = False
        dtghistorico.Visible = False
        dtgcheck.Visible = False
        dtgnovedad.Visible = False
