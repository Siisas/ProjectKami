<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Solicitud.aspx.vb" Inherits="digitacion.Solicitud" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Solicitudes Claro</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td style="font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    valign="top" class="style9">
                                &nbsp;<asp:LinkButton ID="lnknueva" runat="server">Nueva Solicitud</asp:LinkButton>
&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td style="font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    valign="top" class="style9">
                                <asp:Panel ID="pnnueva" runat="server" Visible="False">
                                    <asp:Button ID="btnguardar" runat="server" style="height: 26px" 
                                        Text="Guardar" />
                                    <br />
                                    <asp:Label ID="lblticket" runat="server" Text="Solicitud Asignada No.: " 
                                    ...
                                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                                        <tr>
                                            ...
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drltiposolicitud" runat="server" Height="22px" 
                                                    Width="322px">
                                                </asp:DropDownList>
                                            </td>
                                            <td class="textotittabla">
                                                Prioridad</td>
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drlpriorizacion" runat="server" Height="22px" 
                                                    Width="322px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="textotittabla">
                                                Adjunto</td>
                                            <td class="celdascons">
                                                <asp:FileUpload ID="Fluadjunto" runat="server" />
                                            </td>
                                        </tr>
                                    </table>
                                    <br />
