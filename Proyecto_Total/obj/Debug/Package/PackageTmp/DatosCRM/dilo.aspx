            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Registro DILO</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                        ...
                        <tr>
                            ...
                            <td class="textotittabla">
                                Estado Incidente</td>
                            <td class="celdascons">
                                <asp:DropDownList ID="drltipincidente" runat="server" Height="22px" 
                                    Width="322px">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td class="textotittabla">
                                Mesa Escalada</td>
                            <td class="celdascons">
                                <asp:DropDownList ID="drlmesaesc" runat="server" Height="27px" 
                                    Width="249px">
