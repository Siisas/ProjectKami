            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Check Documental</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                        ...
                        <tr>
                            <td class="textotittabla">
                                Tipo Documental</td>
                            <td class="celdascons">
                                <asp:DropDownList ID="drltipodoc" runat="server" Height="26px" Width="333px">
                                </asp:DropDownList>
                            </td>
                            <td class="textotittabla">
                                Observación</td>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <input id="File1" runat="server" name="File1" size="78" 
                        style="Z-INDEX: 114; POSITION: absolute; WIDTH: 839px; HEIGHT: 22px; TOP: 318px; LEFT: 267px" 
                        type="file" />Detalle Documental<asp:Label ID="lblcuenta" runat="server"></asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
