    ...
    <div>
        ...
        <table style="width: 100%; height: 100%">
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Solicitud y Consulta de Documentos</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td style="width:15%; font-weight: 700; font-family: Arial, Helvetica, sans-serif; font-size: medium;" 
                    valign="top" class="style3">
                                <asp:Label ID="lblaviso" runat="server" Font-Size="Small" 
                        ForeColor="#000066">Por favor en la casilla de &quot;Observación&quot; incluir la información detallada del requerimiento, por ejemplo, para certificación laboral: a quien va dirigida, en caso de desprendible de nómina: el periodo solicitado, etc. Entre más explícito sea, con mayor facilidad podremos colaborarle. </asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
