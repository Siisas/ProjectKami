                        ...
                        <Columns>
                          <asp:TemplateField HeaderText="Foto">
                                ...
                                <asp:TemplateField HeaderText="Hoja de Vida">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" text='<%#Databinder.Eval(container, "DataItem.rutahv")%>' NavigateUrl='<%#Databinder.Eval(container, "DataItem.rutahv","~/RRHH/data_hv/{0}")%>' Target='_blank'></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>
