<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="conscentinela.aspx.vb" Inherits="digitacion.conscentinela" %>
        ...
        <table style="width: 100%; height: 100%">
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Consulta de Entrada y Salida</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                        <tr>
                            <td class="textotittabla">
                                Código</td>
                            <td class="celdascons">
                                <asp:TextBox ID="txtcod" runat="server" Width="25%"></asp:TextBox>
                            </td>
                            <td class="textotittabla">
                                &nbsp;</td>
                            <td class="celdascons">
                        ...
                        <tr>
                            <td class="textotittabla">
                                Fecha Inicial</td>
                            <td class="celdascons">
                                <asp:TextBox ID="txtfcini" runat="server" Width="24%"></asp:TextBox>
            ...
            <tr>
                <td class="celdasder">
                    &nbsp;</td>
                <td class="celdascent">
                    &nbsp;Registros&nbsp;&nbsp; <asp:Label ID="lblcuenta" runat="server"></asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
