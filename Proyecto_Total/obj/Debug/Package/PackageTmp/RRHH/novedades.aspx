            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Novedades de nómina</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                        ...
                        <tr>
                            <td class="textotittabla">
                                ID Modificar</td>
                            <td class="celdascons">
                                <asp:TextBox ID="txtid" runat="server" Width="20%"></asp:TextBox>
                            </td>
                            <td class="celdascons">
                    ...
                    <table border="1" cellpadding="1" cellspacing="1" class="style1">
                        <tr>
                            <td class="textotittabla">
                                Fecha Novedad</td>
                            <td class="celdascons">
                                <asp:TextBox ID="txtfcnov" runat="server" Width="32%"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td class="celdascons">
                                Días&nbsp;
                                <asp:TextBox ID="txtdia" runat="server" Width="31px"></asp:TextBox>
&nbsp;Horas&nbsp;
                                <asp:TextBox ID="txthora" runat="server" Width="31px"></asp:TextBox>
                            </td>
                            <td class="textotittabla">
                                Estado</td>
                            <td class="celdascons">
                                <asp:TextBox ID="txtestado" runat="server" Width="51%"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="textotittabla">
                                Repone</td>
                            <td class="celdascons">
                                <asp:RadioButtonList ID="rdbrepone" runat="server" Width="88px">
            ...
            <tr>
                <td class="celdasder">
                    &nbsp;</td>
                <td class="celdascent">
                    Detalle Novedades por usuario&nbsp;&nbsp; <asp:Label ID="lblcuenta" runat="server"></asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
