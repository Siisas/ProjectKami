<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="consincvoz.aspx.vb" Inherits="digitacion.consincvoz" %>
            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Consulta Inconsistencias Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
