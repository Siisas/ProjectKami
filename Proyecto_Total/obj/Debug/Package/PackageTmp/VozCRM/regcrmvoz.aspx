            ...
            <tr>
                ...
                <td class="celdascent">
                    <asp:Label ID="lblmsg0" runat="server" 
                        style="font-size: medium; font-style: italic">Registro CRM Voz</asp:Label>
                </td>
                <td class="celdasder">
                    &nbsp;</td>
            </tr>
                                    ...
                                    Height="22px" Width="322px">
                                        ...
                                        <tr>
                                            ...
                                            <td class="textotittabla">
                                                Barrio</td>
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drlbarrio" runat="server" Height="22px" Width="322px" 
                                                    AutoPostBack="True">
                                                    <asp:ListItem Value="1">- Seleccione -</asp:ListItem>
                                                    <asp:ListItem>SI</asp:ListItem>
                                                    <asp:ListItem>NO</asp:ListItem>
                                        ...
                                        <tr>
                                            ...
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drlcaractfalla" runat="server" Height="22px" 
                                                    Width="322px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drlcondic" runat="server" Height="22px" Width="322px">
                                                </asp:DropDownList>
                                            </td>
                                            <td class="textotittabla">
                                                Tipo de Cierre</td>
                                            <td class="celdascons">
                                                <asp:DropDownList ID="drltcierre" runat="server" Height="22px" Width="322px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
